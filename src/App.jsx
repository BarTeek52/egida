...
export default function App() {
    ...
    const handleGenerateAndSave = async () => {
        ...
        try {
            ...
            await loadFont('[https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Regular.ttf](https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Regular.ttf)', 'Kiro-Regular.ttf', 'Kiro', 'normal');
            await loadFont('[https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Medium.ttf](https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Medium.ttf)', 'Semplicita-Bold.ttf', 'Semplicita', 'bold');
            await loadFont('[https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Medium.ttf](https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/fonts/Roboto/Roboto-Medium.ttf)', 'Kiro-Bold.ttf', 'Kiro', 'bold');
            ...
            await new Promise((resolve) => {
                ...
                img.onerror = () => { 
                    ...
                    imgUrl.src = '[https://palladatrans.pl/wp-content/uploads/2021/04/Logo-Pallada-Trans.png](https://palladatrans.pl/wp-content/uploads/2021/04/Logo-Pallada-Trans.png)';
                };
                    ...
                    <div className="max-w-4xl mx-auto space-y-6 pb-20 fade-in">
                        <header className="bg-white rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4 border border-slate-200">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-xl font-bold text-slate-800 tracking-tight">Wypowiedzenia OC</h1>
                            </div>
